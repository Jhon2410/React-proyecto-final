              ...
              <div className="col-md-6 col-lg-7 col-xl-8">
                ...
                <div className="pt-3 pe-3" data-mdb-perfect-scrollbar="true"
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    ...
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3" style={{ background : "#f5f6f7" }}>Lorem ipsum
                        dolor
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" style={{width : "45px" ,  height : "100%"}}/>
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3" style={{ background : "#f5f6f7" }}>Duis aute
                        irure
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" style={{width : "45px" ,  height : "100%"}}/>
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3" style={{ background : "#f5f6f7" }}>Sed ut
                        perspiciatis
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" style={{width : "45px" ,  height : "100%"}}/>
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3" style={{ background : "#f5f6f7" }}>Neque porro
                        quisquam
